...
import backstage.Bitboard;
import backstage.Board;
import backstage.Constants;
import backstage.File;
import backstage.Piece;
import backstage.PieceType;
import backstage.Rank;
...
public class MoveList extends LinkedList<Move> {
    ...
    protected Move decodeSan(Board board, String san, Side side) throws MoveConversionException {
        ...
        Piece promotion = strPromotion.length() == 0 ? Piece.NONE :
